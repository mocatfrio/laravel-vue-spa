  ...
  <div class="card card-body">
    <form>
      ...
      <div class="form-group">
        ...
        <input type="text" name="email" placeholder="Enter your e-mail" class="form-control" v-model="user.email" :class="[{ 'is-invalid': errorFor('email') }]">
    ...
    <button class="btn btn-primary btn-lg btn-block" @click.prevent="register" :disabled="loading">Register</button>
    <hr>
    <div>
      Already have an account?
      <router-link :to="{ name: 'login' }" class="font-weight-bolder">Login</router-link>
    </div>
  </div>
</div>
</template>
