...
<div class="w-50 m-auto">
  <div class="card card-body">
    ...
    <button class="btn btn-primary btn-lg btn-block" @click.prevent="login" :disabled="loading">Log in</button>
    <hr>
    <div>
      No account yet?
    ...
    <div>
      Forgotten password?
      <router-link :to="{ name: 'home' }" class="font-weight-bolder">Reset password</router-link>
    </div>
  </div>
</div>
</template>
